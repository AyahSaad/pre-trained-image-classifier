...
def calculates_results_stats(results_dic):
    ...
    # Iterate through all images in results_dic
    for key, value in results_dic.items():
        pet_label, classifier_label, match, pet_is_dog, classifier_is_dog = value
    ...
    # Store all counts and percentages in the dictionary
